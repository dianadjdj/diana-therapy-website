# Considering Therapy: Where to Start | Diana Chu, LMFT

> A primer for founders and executives weighing whether to start therapy. What you are probably asking, what a first session looks like, EMDR, and telehealth.

Canonical URL: https://dianachutherapy.com/considering-therapy.html
...
Where Most People Are When They Land Here
...
| --- | --- |
| [Do I actually need therapy?](blog/do-i-need-therapy-executives.html) | The threshold problem for high achievers. Why "I should be able to handle this" is the thing keeping the cost going up. |
| [What happens in a first session?](blog/first-therapy-session-founder.html) | What a therapist who works with founders is actually listening for, what they will not do, and how trust starts when you are used to being managed. |
| [What is EMDR and is it for me?](blog/emdr-for-executives.html) | When EMDR helps executive and founder clients, when it does not, and why the work can feel surprisingly efficient. |
